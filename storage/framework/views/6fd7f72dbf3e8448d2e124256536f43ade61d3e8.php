...
<div class="row">
    ...
    <div class="col-md-1">
        ...
        <?php echo Form::select('status',['delivered' => 'تم تسليمها ','not_delivered' => 'لم يتم تسليمها ','not_been_withdrawn' => 'لم يتم سحبها ','rejected' => 'رفض' ,  'photo_only'=>'تصوير فقط'],Arr::get($filter,'status'), ['class' => 'form-control'  , 'placeholder'=> __('lang.status')] ); ?>
            ...
            <div class="col-md-1">
                        <div class="form-group">
                            <label for="projectinput1"><i class="fa fa-date"></i> البيان الجمركي </label>
...
<td><?php echo e($row->sample_collection_location ?? '-'); ?>-<?php echo e($row->container_location ?? '-'); ?></td>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/wqbicmmy/adeco.com/adeco/public/test1/resources/views/backend/pages/samplings/index.blade.php ENDPATH**/ ?>