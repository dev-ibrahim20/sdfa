...
<td> <input  name='permissions[]'  value='view_sampling_statistics'  type="checkbox" <?php if( isset($data->id) && $data->permissions->contains('name' , 'view_sampling_statistics')): ?> checked <?php endif; ?> > </td>
</tr>
<tr>
     <td> تعديل تاريخ ووقت تقديم النموذج </td>
    <td> <input name='permissions[]' value='edit_sampling_datetime' type="checkbox" <?php if(isset($data->id) && $data->permissions->contains('name', 'edit_sampling_datetime')): ?> checked <?php endif; ?> > </td>   
</tr>    
<tr>
     <td> حذف صنف من العينة </td>
    <td> <input name='permissions[]' value='delete_sampling_item' type="checkbox" <?php if(isset($data->id) && $data->permissions->contains('name', 'delete_sampling_item')): ?> checked <?php endif; ?> > </td>   
</tr>    
</table>
...
<?php /**PATH /home2/wqbicmmy/adeco.com/adeco/public/website_db52dcbb/resources/views/backend/pages/roles/form.blade.php ENDPATH**/ ?>