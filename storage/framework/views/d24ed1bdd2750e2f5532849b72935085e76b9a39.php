            ...
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            <label for="projectinput1"><i class="fe-list"></i> <?php echo e(__('lang.form_submission_time')); ?></label>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_sampling_datetime')): ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="projectinput1"><i class="fe-list"></i> <?php echo e(__('lang.form_submission_date')); ?></label>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_sampling_datetime')): ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="projectinput1"><i class="fe-list"></i>
                                <?php echo e(__('lang.customs_clearance_contact_number')); ?> <span class="text-danger">*</span></label>
                ...
                <?php if(isset($data->samplingItems) && count($data->samplingItems) > 0): ?>   
                <?php $__currentLoopData = $data->samplingItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row sampling-row">
                        <?php echo Form::hidden('sampling_item_id[]', $value->id); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_sampling_item')): ?>
               ...
               <?php else: ?>
                <div class="row sampling-row">
                    <?php echo Form::hidden('sampling_item_id[]', null); ?>
...
<?php /**PATH /home2/wqbicmmy/adeco.com/adeco/public/website_db52dcbb/resources/views/backend/pages/samplings/form.blade.php ENDPATH**/ ?>