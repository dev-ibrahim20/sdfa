...
<h4 class="header-title mb-4"> <?php echo e(__('lang.update_role')); ?>   </h4>
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/roles/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>
...
<title><?php echo e(__('lang.update_role')); ?>  | <?php echo e(__('lang.app_name')); ?></title>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/wqbicmmy/adeco.com/adeco/public/website_db52dcbb/resources/views/backend/pages/roles/edit.blade.php ENDPATH**/ ?>