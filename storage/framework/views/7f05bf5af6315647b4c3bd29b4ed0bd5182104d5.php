...
<h4 class="header-title mb-6"><?php echo e(__('lang.update_workplaces')); ?> | <?php echo e($data->title); ?> </h4>
<?php echo Form::model( $data ,[ 'url' =>  config('settings.BackendPath').'/workplaces/'.$data->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]); ?>

<?php echo $__env->make('backend.pages.workplaces.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo Form::close(); ?>
...
<title><?php echo e(__('lang.update_workplaces')); ?> | <?php echo e($data->title); ?> | <?php echo e(config('settings.ProjectName')); ?></title>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/wqbicmmy/adeco.com/adeco/public/website_db52dcbb/resources/views/backend/pages/workplaces/edit.blade.php ENDPATH**/ ?>