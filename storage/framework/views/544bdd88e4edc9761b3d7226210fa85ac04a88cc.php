...
<h4 class="header-title mb-6"> <?php echo e(__('lang.create_workplaces')); ?> </h4>

<?php echo Form::open([ 'route' => 'workplaces.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]); ?>
...
<title>  <?php echo e(__('lang.create_workplaces')); ?> |  <?php echo e(config('settings.ProjectName')); ?></title>
...
<?php echo $__env->make('backend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/wqbicmmy/adeco.com/adeco/public/website_db52dcbb/resources/views/backend/pages/workplaces/create.blade.php ENDPATH**/ ?>