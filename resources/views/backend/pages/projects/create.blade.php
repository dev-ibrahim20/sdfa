...
<p class="header-title mb-6"> <B> {{__('lang.create_project')}}</B> </p>

{!! Form::open([ 'route' => 'projects.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_project')}} |  {{config('settings.ProjectName')}}</title>
