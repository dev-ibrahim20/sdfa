...
<a href="{{url('')}}/{{config('settings.BackendPath')}}/projects/create"><button type="button" class="btn btn-danger btn-rounded mb-3"><i class="mdi mdi-plus"></i> {{__('lang.create_project')}} </button></a>
...
<div class="row">
@include('backend.pages.projects.table')
</div>
<!-- end row -->
