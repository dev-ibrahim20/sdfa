...
<h4 class="header-title mb-6"> {{__('lang.create_building_tasks')}} </h4>

{!! Form::open([ 'route' => 'building_tasks.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_building_tasks')}} |  {{config('settings.ProjectName')}}</title>
