...
<p class="header-title mb-6"> <B> {{__('lang.update')}} | {{$job_order->title}} </B> </p>

{!! Form::model( $job_order ,[ 'url' =>  config('settings.BackendPath').'/job-orders/'.$job_order->id, 'method'=>'PATCH' ,  'class' => 'form' ,  'files' => 'true' ]) !!}
