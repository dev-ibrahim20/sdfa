...
<p class="header-title mb-6"> <B> {{__('lang.create_building')}}</B> </p>

{!! Form::open([ 'route' => 'buildings.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_building')}} |  {{config('settings.ProjectName')}}</title>
