...
<div class="row">
    ...
    <div class="col-md-2">
        ...
        {!! Form::select('workplace_id', $workplaces,Arr::get($filter,'workplace_id'), ['class' => 'form-control'  , 'placeholder'=> __('lang.workplace_address')] ) !!}
                ...
                <div class="col-md-2">
        <div class="form-group">
        <label for="projectinput1"><i class="fa fa-list"></i> {{__('lang.city')}} </label>
        {!! Form::select('city_id', $cities,Arr::get($filter,'city_id'), ['class' => 'form-control'  , 'placeholder'=> __('lang.city')] ) !!}
        </div>
        </div>
        <div class="col-md-2">
        <div class="form-group">
