            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <h4 class="header-title mb-6"> {{ __('lang.create_samplings') }} </h4>

                        {!! Form::open(['route' => 'samplings.store', 'role' => 'form', 'class' => 'form', 'files' => 'true']) !!}
                        @include('backend.pages.samplings.form')
                        {!! Form::close() !!}
                    </div>
                </div><!-- end col -->
            </div>
...
@section('head')
    <title> {{ __('lang.create_samplings') }} | {{ config('settings.ProjectName') }}</title>
    ...
    <link href="{{ url('') }}/assets/admin/libs/datatables/dataTables.bootstrap4.css" rel="stylesheet"
        type="text/css" />
    <link href="{{ url('') }}/assets/admin/libs/datatables/responsive.bootstrap4.css" rel="stylesheet"
        type="text/css" />
    <!-- third party css end -->
    ...
    <!-- App css -->
    <link href="{{ url('') }}/assets/admin/css-{{ DirUser() }}/bootstrap.min.css" rel="stylesheet"
        type="text/css" />
    <link href="{{ url('') }}/assets/admin/css-{{ DirUser() }}/icons.min.css" rel="stylesheet"
        type="text/css" />
    <link href="{{ url('') }}/assets/admin/css-{{ DirUser() }}/app.min.css" rel="stylesheet" type="text/css" />



    <link href="{{ url('') }}/assets/admin/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.css" rel="stylesheet"
        type="text/css" />
@endsection
