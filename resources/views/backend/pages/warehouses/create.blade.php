...
<p class="header-title mb-6"> <B> {{__('lang.create_warehouse')}} | {{$project->title ?? __('lang.all_warehouses')}}  </B> </p>

{!! Form::open([ 'route' => 'warehouse_store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_warehouse')}} |  {{config('settings.ProjectName')}}</title>
