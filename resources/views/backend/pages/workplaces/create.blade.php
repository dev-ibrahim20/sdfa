...
<h4 class="header-title mb-6"> {{__('lang.create_workplaces')}} </h4>

{!! Form::open([ 'route' => 'workplaces.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_workplaces')}} |  {{config('settings.ProjectName')}}</title>
