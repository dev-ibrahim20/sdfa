...
<h4 class="header-title mb-6"> Create Floor </h4>

{!! Form::open([ 'route' => 'building_floors.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_building_floors')}} |  {{config('settings.ProjectName')}}</title>
