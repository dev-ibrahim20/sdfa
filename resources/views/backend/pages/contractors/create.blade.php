...
<p class="header-title mb-6"> <B> {{__('lang.create_contractor')}}   </B> </p>

{!! Form::open([ 'route' => 'contractors.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_contractor')}} |  {{config('settings.ProjectName')}}</title>
