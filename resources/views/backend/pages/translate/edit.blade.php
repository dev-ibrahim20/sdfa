                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <h4 class="header-title mb-4">{{__('lang.edit_languages')}}</h4>



{!! Form::open(array('url' => config('settings.BackendPath').'/translate/'.$lang)) !!}
@include('backend.pages.translate.form')
{!!Form::close()!!}
