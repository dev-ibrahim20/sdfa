...
<p class="header-title mb-6"> <B> {{__('lang.create_vendor')}} </B> </p>

{!! Form::open([ 'route' => 'vendors.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_vendor')}} |  {{config('settings.ProjectName')}}</title>
