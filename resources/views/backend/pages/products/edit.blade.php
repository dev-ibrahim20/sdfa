...
<p class="header-title mb-6"> <B> {{__('lang.update_product')}} | {{$product->title}} </B> </p>

{!! Form::model( $product ,[ 'route' => ['product_update',$product->id] , 'method'=>'POST' ,  'class' => 'form' ,  'files' => 'true' ]) !!}
