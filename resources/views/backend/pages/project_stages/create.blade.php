...
<h4 class="header-title mb-6"> {{__('lang.create_project_stages')}} </h4>

{!! Form::open([ 'route' => 'project_stages.store', 'role' => 'form' , 'class' => 'form' , 'files'=>'true' ]) !!}
...
<title>  {{__('lang.create_project_stages')}} |  {{config('settings.ProjectName')}}</title>
